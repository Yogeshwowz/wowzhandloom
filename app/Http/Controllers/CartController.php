...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request){
        ...
        $already_cart = Cart::where('user_id', session()->getId())->where('order_id',null)->where('product_id', $product->id)->first();
        // return $already_cart;
        if($already_cart) {
            // dd($already_cart);
            ...
            $cart->save();
            $wishlist=Wishlist::where('user_id',session()->getId())->where('cart_id',null)->update(['cart_id'=>$cart->id]);
        }
