...
class AdminController extends Controller
{
    ...
    public function about(){
        $data=About::first();
        return view('backend.about.aboutpage')->with('data',$data);
    }
     ...
     public function aboutUpdate(Request $request){
        // return $request->all();
        $this->validate($request,[
            'story_background'=>'required',
            'our_story'=>'required|string',
            'section2_background'=>'required',
            'side_image'=>'required',
        ...
        if($status){
            request()->session()->flash('success','About Content successfully updated');
        }
        else{
            request()->session()->flash('error','Please try again');
        }
    ...
    public function settingsUpdate(Request $request){
        ...
        $this->validate($request,[
            ...
            'home_section2_background'=>'required',
            'home_section3_background'=>'required',
            'recipes_background'=>'required',
            'footer_background'=>'required',
            'page_banners'=>'required',
