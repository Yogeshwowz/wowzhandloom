    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div id="holder" style="margin-top:15px;max-height:100px;"></div>
         ...
         <div class="form-group">
          <label for="inputTitle" class="col-form-label">Feautre <span class="text-danger">*</span></label>
          <input id="inputTitle" type="text" name="feature" placeholder="like(test1,test2,test3)"  value="{{$product->feature}}" class="form-control">
          @error('feature')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
