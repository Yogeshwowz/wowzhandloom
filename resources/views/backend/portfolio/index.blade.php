...
@section('title','E-SHOP || Portfolio')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Portfolio List</h6>
      <a href="{{route('portfolio.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Portfolio</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            @foreach($portfolios as $portfolio)   
                <tr>
                    ...
                    <td>
                        @if($portfolio->photo)
                            <img src="{{$portfolio->photo}}" class="img-fluid zoom" style="max-width:80px" alt="{{$portfolio->photo}}">
                        @else
        ...
        @else
          <h6 class="text-center">No portfolios found!!! Please create portfolio</h6>
        @endif
      </div>
    </div>
</div>
