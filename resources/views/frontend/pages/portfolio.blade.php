    ...
    <section class="portfolio-section alternate2 portfolio-with-filter">
        <div class="container-fluid">
           ...
           <div class="row">
                ...
                <div class="portfolio-block-four col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><img src="{{$portfolio->photo}}" alt=""></figure>
                            <div class="hover-effect">
                                ...
                                <a href="{{route('portfolio.detail',$portfolio->slug)}}" class="link"></a>
                            </div>
                        </div>

                        <div class="lower-content">
                            <div class="title-box">
                                <h3><a href="{{route('portfolio.detail',$portfolio->slug)}}"><svg class="div_left" viewBox="0 0 152 51"> <path d="M18,13.7c-2.3,0.6-11.9,3.9-8.4,0s11.9-2.2,16.2-1.6c10.8,1.7,20.2,6.1,29.7,11.2c10.6,5.8,21.3,11.1,31.4,17.7 c8.6,5.6,18.3,9.5,28.7,9.9c15.8,0.6,31.9-11.4,35.8-26.8c2-8-0.7-16.8-7.7-21.6c-10.6-7.3-14.3,2.7-16.2,11.6 c2.4-0.1,5.8-1.1,8-0.5c3,0.9,2.1,0.9,3.6,4.1c1.5,3.3,1.8,7,0.9,10.5c-2.5,9.4-13,15.2-22.1,15.9c-20.2,1.6-39.5-16.8-55.5-26.7 C48.8,9.2,22.4-8.4,6.6,4.7c-5.4,4.5-10,15.8-3.3,21.2C12.6,33.3,16.8,20.1,18,13.7z"></path></svg>{{$portfolio->title}}<svg class="div_right" viewBox="0 0 152 51"><path d="M134,13.7c2.3.55,11.86,3.93,8.38,0s-11.87-2.21-16.21-1.55C115.4,13.8,106,18.23,96.5,23.38,85.88,29.16,75.2,34.5,65.07,41.12c-8.57,5.6-18.31,9.45-28.66,9.86C20.56,51.61,4.49,39.55.64,24.17c-2-8,.72-16.81,7.74-21.63C19-4.73,22.65,5.27,24.55,14.15c-2.37-.14-5.8-1.11-8-.46-3,.87-2.06.91-3.64,4.11A16,16,0,0,0,12,28.29c2.45,9.4,13,15.18,22.12,15.89,20.17,1.56,39.46-16.81,55.54-26.67,13.57-8.32,40-25.86,55.71-12.86,5.44,4.5,10,15.83,3.29,21.24C139.41,33.33,135.18,20.06,134,13.7Z" transform="translate(0)"></path></svg></a></h3>
                            </div>
                            <div class="text">{{strip_tags($portfolio->description)}}</div>
                        </div>
                    </div>
                </div>
                @endforeach
