...
@section('title','Ecommerce || Portfolio Detail')
        ...
        <div class="auto-container">
            <div class="content-box">
                ...
                <div class="lower-content">
                    <div class="title-box">
                        <h3>{{$post->title}}</h3>
                       <!--  <div class="term"><a href="#"></a>Masonry</div> -->
                    </div>
            ...
            <div class="related-products">
                ...
                <div class="row">
                    ...
                    <div class="portfolio-block col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image-box"><figure class="image"><img src="{{$post->photo}}" alt=""></figure></div>
                            <div class="portfolio-hover">
                                ...
                                <h3><a href="portfolio-single.html">{{$post->title}}</a></h3>
                            </div>
                        </div>
                    </div>
                    @endforeach
